  ...
  return (
    <div className="p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Button onClick={openAdd} data-ocid="admin.events.add.button">
                ...
                <TableRow key={e.id} data-ocid={`admin.events.row.${i + 1}`}>
                  ...
                  <TableCell className="flex gap-2">
                    <Button
                      ...
                      variant="outline"
                      onClick={() => openEdit(e)}
                      data-ocid={`admin.event.edit.button.${i + 1}`}
                    >
                    ...
                    <Button
                      ...
                      data-ocid={`admin.event.delete.button.${i + 1}`}
                    >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent data-ocid="admin.event.dialog">
          <DialogHeader>
          ...
          <div className="space-y-3">
            ...
            <Button
              className="w-full"
              onClick={handleSave}
              data-ocid="admin.event.save.button"
            >
              Save Event
            </Button>
          </div>
