...
export default function CoordinatorReports() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">Volunteer Reports</h1>
        <p className="text-muted-foreground">
          Review and approve submitted reports
        </p>
      </div>
      <Table data-ocid="coord.reports.table">
        <TableHeader>
          <TableRow>
          ...
          {store.state.reports.length === 0 ? (
            <TableRow>
              <TableCell
                ...
                data-ocid="coord.reports.empty_state"
              >
            ...
            store.state.reports.map((r, i) => (
              <TableRow key={r.id} data-ocid={`coord.reports.row.${i + 1}`}>
                ...
                <TableCell>
                  <Input
                    ...
                    data-ocid={`coord.report.feedback.input.${i + 1}`}
                    className="w-40"
                  />
                </TableCell>
                <TableCell>
                    ...
                    {r.status === "Pending" && (
                      <>
                        <Button
                          ...
                          data-ocid={`coord.report.approve.button.${i + 1}`}
                        >
                          Approve
                        </Button>
                        <Button
                          ...
                          data-ocid={`coord.report.reject.button.${i + 1}`}
                        >
                          Reject
                        </Button>
                      </>
